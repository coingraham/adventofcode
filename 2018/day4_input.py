...
test_time_entries = """[1518-11-01 00:00] Guard #10 begins shift
...
real_time_entries = """[1518-05-28 00:59] wakes up
...
for entry in real_time_entries.splitlines(False):
    entry_parts = entry.split("]")
    entry_date = datetime.strptime(entry_parts[0], '[%Y-%m-%d %H:%M')
    entry_dictionary[entry_date] = entry_parts[1].lstrip(" ")

sorted_entries = sorted(entry_dictionary.items())
